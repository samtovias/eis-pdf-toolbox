...
switch problem
    ...
    case 7
        ...
        data.ncon = 0;
        data.nreal = 30;
        data.min_realvar = zeros(1,30);
        data.max_realvar = ones(1,30);
        data.pcross_real = 0.9;
    ...
    case 10
        ...
        data.ncon = 0;
        data.nreal = 10;
        data.min_realvar = [0 -5*ones(1,9)];
        data.max_realvar = [1 5*ones(1,9)];
        data.pcross_real = 0.9;
        data.pmut_real = 0.1;
        data.eta_c = 15;
        data.eta_m = 20;
    ...
    case 11
        ...
        data.nreal = 0;
        data.nbin = 11;
        data.nbits = [30 5*ones(1,10)];
        data.min_binvar = zeros(1,11);
        data.max_binvar = [30 5*ones(1,10)];
        data.pcross_bin = 0.9;
    ...
    case 12
        ...
        data.ncon = 0;
        data.nreal = 10;
        data.min_realvar = zeros(1,10);
        data.max_realvar = ones(1,10);
        data.pcross_real = 0.9;
        data.pmut_real = 0.1;
        data.eta_c = 15;
        data.eta_m = 20;
