...
% child1 = []; 
% child2 = []; 
% parent1_strings = old_pop_strings(i,:);
% parent2_strings = old_pop_strings(i+1,:); 
% child1_strings = new_pop_strings(i,:);
% child2_strings = new_pop_strings(i+1,:);
% pcross_real = pcross_real; 
% pcross_bin = pcross_bin;
% nbincross = nbincross; 
% nrealcross = nrealcross;
% nobj = nobj;
% nreal = nreal;
% ncon = ncon; 
% eta_c = eta_c; 
