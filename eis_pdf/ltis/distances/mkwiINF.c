/*       
    C MEX Function.
    MKWIINF Minkowski unnormalized distance of order INF.  
        MDINF = MKWIINF(X1,X2) computes the Minkowski unnormalized distance between 
        two single vectors. X1 and X2 are single vectors of 1-by-D size. MDINF 
        is the Minkowski unnormalized distance of order INF. 
        
        Compile MEX function: 
        --------------------
        mex -O mkwiINF.c -largeArrayDims; % Build an executable file for Matlab engine
        ...
        mdINF = mkwiINF(x1,x2);           % Minkowski unnormalized distance
        ...
        MKWIINF Version 1.0 (Matlab R2022a)
        June 2022
