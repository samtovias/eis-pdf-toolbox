/*     
    C MEX Function.
    DINFMETRIC Yang unnormalized distance of order INF.  
        YDINF = DINFMETRIC(X1,X2) computes the Yang unnormalized distance between 
        two single vectors. X1 and X2 are single vectors of 1-by-D size. YDINF 
        is the Yang unnormalized distance of order INF. 
        
        Compile MEX function: 
        --------------------
        mex -O dINFmetric.c -largeArrayDims; % Build an executable file for Matlab engine
        ...
        ydINF = dINFmetric(x1,x2);           % Yang unnormalized distance
        ...
        DINFMETRIC Version 1.0 (Matlab R2022a)
        June 2022
