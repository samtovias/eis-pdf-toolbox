/*       
    C MEX Function.
    MKWI05 Minkowski unnormalized distance of order 0.5.  
        MD05 = MKWI05(X1,X2) computes the Minkowski unnormalized distance between 
        two single vectors. X1 and X2 are single vectors of 1-by-D size. MD05 
        is the Minkowski unnormalized distance of order 0.5. 
        
        Compile MEX function: 
        --------------------
        mex -O mkwi05.c -largeArrayDims; % Build an executable file for Matlab engine
        ...
        md05 = mkwi05(x1,x2);            % Minkowski unnormalized distance
        ...
        MKWI05 Version 1.0 (Matlab R2022a)
        June 2022
