/*     
    C MEX Function.
    D2METRIC Yang unnormalized distance of order 2.  
        YD2 = D2METRIC(X1,X2) computes the Yang unnormalized distance between 
        two single vectors. X1 and X2 are single vectors of 1-by-D size. YD2 
        is the Yang unnormalized distance of order 2. 
        
        Compile MEX function: 
        --------------------
        mex -O d2metric.c -largeArrayDims; % Build an executable file for Matlab engine
        ...
        yd2 = d2metric(x1,x2);             % Yang unnormalized distance
        ...
        D2METRIC Version 1.0 (Matlab R2022a)
        June 2022
